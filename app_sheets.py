        ...
        with st.spinner('Menarik data dari Google Sheets dan membuat visualisasi...'):
            ...
            for cat in df_ex['category'].unique():
                ...
                if len(sub) > 0:
                    ...
                    # General
                    fig_g = px.bar(g_count, x='Total', y=" ", orientation='h', title=f'Topik General - {cat}', text='Total', color_discrete_sequence=[COLOR_MAP.get(cat, 'gray')])
                    title_x=0.5
                    ...
                    # Spesifik
                    fig_s = px.bar(s_count, x='Total', y=" ", orientation='h', title=f'Topik Spesifik - {cat}', text='Total', color_discrete_sequence=[COLOR_MAP.get(cat, 'gray')])
                    title_x=0.5
